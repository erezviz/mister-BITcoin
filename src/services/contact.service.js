...
async function query(filterBy = null) {
    ...
    if (filterBy && filterBy.term) contacts = filter(filterBy.term)
...
//         let contactsToReturn = storageService.load(KEY)
//         if (!contactsToReturn) {
//             contactsToReturn = contacts
//             storageService.save(KEY, contactsToReturn)
//         }
...
//         }
//         storageService.save(KEY, contacts)
//         resolve(contact)
//     })
// }
